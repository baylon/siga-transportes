...
<form name="formAbastecimentos" id="formAbastecimentos" action="${linkTo[AbastecimentoController].salvar}" method="post" cssClass="form" enctype="multipart/form-data"> 
	...
	<div class="gt-content-box gt-form clearfix">
		<div class="coluna margemDireitaG">
			...
			<siga:select name="abastecimento.condutor.id" list="condutores" listKey="id" listValue="dadosParaExibicao" value="${abastecimento.condutor.id}" />

			<label for= "abastecimento.veiculo.id" class= "obrigatorio">Ve&iacute;culo</label>
			<siga:select name="abastecimento.veiculo.id" list="veiculos" listKey="id" listValue="dadosParaExibicao" value="${abastecimento.veiculo.id}"  />
		...
		<div class="coluna margemDireitaG">
			...
			<siga:select name="abastecimento.fornecedor.id" list="fornecedores" listKey="id" listValue="razaoSocial" value="${abastecimento.fornecedor.id}" />
